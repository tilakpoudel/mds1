...
From the word cloud, we can see that the word `the`, `and`, `of`, `to`, `in` has the maximum occurrence, thereafter the words `text`, `mine`, `document`, `inform`, `data` are the other words that are more prominent in the documents.